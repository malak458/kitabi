...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $room1->setImage('default-book.jpg');
        ...
        $room2->setImage('default-book.jpg');
        ...
        $room3->setImage('default-book.jpg');
        ...
        $room5->setImage('default-book.jpg');
        ...
        $room6->setImage('default-book.jpg');
