 ...
 */
final class Version20260525173323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD user_id INT DEFAULT NULL, CHANGE `condition` `condition` VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP user_id, CHANGE `condition` `condition` VARCHAR(50) NOT NULL');
    }
}
