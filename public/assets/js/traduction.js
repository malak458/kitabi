const navTranslations = {
    ...
    fr: {
        // ===== NAVBAR =====
        nav_marketplace:
            '<span class="material-icons">local_mall</span> Marché',
        nav_messages:
            '<span class="material-icons">chat_bubble</span> Messages',
        nav_exchanges:
            '<span class="material-icons">swap_horiz</span> Échanges',
        nav_favorites: '<span class="material-icons">favorite</span> Favoris',
        nav_reading_rooms:
            '<span class="material-icons">import_contacts</span> Salons de lecture',
        nav_dashboard:
    ...
    ar: {
        ...
        nav_exchanges:
            '<span class="material-icons">swap_horiz</span> التبادلات',
...
window.setLang = function (lang) {
    ...
    document
        ...
        .forEach((el) => (el.innerHTML = t.card_details));
    document
        .querySelectorAll(".chat")
        .forEach((el) => (el.innerHTML = t.card_chat));
    document
        .querySelectorAll(".exchange")
        .forEach((el) => (el.textContent = t.badge_exchange));
